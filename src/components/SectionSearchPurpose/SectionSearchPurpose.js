...
// external
import './sectionSearchPurpose.css';
...
const SectionSearchPurpose = props => {
  ...
  const slideLeftCampain = () => {
    var slider = document.getElementById("sliderpurpose");
  ...
  const title = intl.formatMessage({ id: 'SectionSearchPurpose.title' });
  const seeMore = intl.formatMessage({ id: 'SectionSearchPurpose.seeMore' });
...
SectionSearchPurpose.propTypes = {
  rootClassName: string,
  className: string,
  intl: intlShape.isRequired
};

export default injectIntl(SectionSearchPurpose);
