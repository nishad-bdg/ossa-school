...
class LocationAutocompleteInputImpl extends Component {
  constructor(props) {
    ...
    this.handlePredictionsSelectStart = this.handlePredictionsSelectStart.bind(
      this
    );
    this.handlePredictionsSelectMove = this.handlePredictionsSelectMove.bind(
      this
    );
    this.handlePredictionsSelectEnd = this.handlePredictionsSelectEnd.bind(
      this
    );
  ...
  render() {
    ...
    const iconClass = classNames(iconClassName || css.icon,{
      [css.iconSuccess]: valid,
      [css.iconError]: !valid && touched
    });
    const inputClass = classNames(css.input, {
      [css.inputSuccess]: valid,
      [css.inputError]: !valid && touched
    });
