...
import css from './SchoolFilterPlain.module.css';
...
class SchoolFilterPlainComponent extends Component {
  constructor(props) {
    super(props);
...
SchoolFilterPlainComponent.defaultProps = {
  rootClassName: null,
  className: null,
  initialValues: null,
  step: number,
...
SchoolFilterPlainComponent.propTypes = {
...
const SchoolFilterPlain = injectIntl(SchoolFilterPlainComponent);

export default SchoolFilterPlain;
