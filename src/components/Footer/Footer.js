...
const renderSocialMediaLinks = intl => {
  const { siteLinePage, siteInstagramPage, siteTwitterHandle } = config;
  ...
  const lineLink = siteLinePage ? (
    <ExternalLink key="linkToFacebook" href={siteLinePage} className={css.icon} title={goToFb}>
      <IconSocialMediaLine />
    </ExternalLink>
  ) : null;
  ...
  return [instragramLink, lineLink, twitterLink].filter(v => v != null);
};
        ...
        <div className={css.content}>
          ...
          <div className={css.links}>
            ...
            <div className={css.infoLinks}>
              <h4 className='linkTitle fw-bold'><FormattedMessage id="Footer.linkTitle1" /></h4>
            ...
            <div className={css.searches}>
              <h4 className='linkTitle fw-bold'><FormattedMessage id="Footer.linkTitle2" /></h4>
              ...
              <li className={css.listItem}>
                ...
                <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
                    <FormattedMessage id="Footer.toInquiries" />
                  </NamedLink>
                </li>
                {/* <li className={css.listItem}>
                  <NamedLink
            ...
            <div className={css.searchesExtra}>
              <h4 className='linkTitle fw-bold'><FormattedMessage id="Footer.linkTitle3" /></h4>

              <ul className={css.list}>
              <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
                    <FormattedMessage id="Footer.toOperateCompany" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
                    <FormattedMessage id="Footer.toPrivacyPolicy" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
