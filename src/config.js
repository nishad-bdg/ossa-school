...
import { currencyConfiguration, conversionRateStore } from './currency-config';
...
const conversionRate = conversionRateStore('USD', process.env.REACT_APP_EXCHANGE_RATE_APIKEY);
...
const siteInstagramPage = 'https://www.facebook.com/Sharetribe/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Sharetribe/';
const siteLinePage = 'https://www.facebook.com/Sharetribe/';
