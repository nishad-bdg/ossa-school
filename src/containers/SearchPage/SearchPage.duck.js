...
export const SEARCH_SCHOOL_LIST_REQUEST =
  'app/SearchPage/SEARCH_SCHOOL_LIST_REQUEST';
export const SEARCH_SCHOOL_LIST_SUCCESS =
  'app/SearchPage/SEARCH_SCHOOL_LIST_SUCCESS';
export const SEARCH_SCHOOL_LIST_ERROR =
  'app/SearchPage/SEARCH_SCHOOL_LIST_ERROR';
...
const listingPageReducer = (state = initialState, action = {}) => {
  ...
  switch (type) {
    ...
    case SEARCH_SCHOOL_LIST_SUCCESS:
      return {
        ...state,
        searchSchoolList: payload,
      };
    default:
      return state;
  }
...
export const searchSchoolListSuccess = response => ({
  type: SEARCH_SCHOOL_LIST_SUCCESS,
  payload: response,
});
...
export const searchListings = searchParams => (dispatch, getState, sdk) => {
  ...
  const searchQueryObj =
    searchParams.address && searchParams.city && searchParams.schoolName
      ? {
          pub_type: 'school',
          pub_country: searchParams.address,
          pub_city: searchParams.city,
          pub_schoolName: searchParams.schoolName,
          per_page: perPage,
        }
      : searchParams.address && searchParams.city
      ? {
          pub_type: 'school',
          pub_country: searchParams.address,
          pub_city: searchParams.city,
  ...
  return integrationSdk.users
    ...
    .then(response => {
      dispatch(searchSchoolListSuccess(response.data.data));
