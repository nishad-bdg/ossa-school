...
import EditAccomodationPage from './EditAccomodationPage/EditAccomodationPage.duck';
import SchoolPhotosPage from './SchoolPhotoPage/SchoolPhotosPage.duck';
import EditFixedCostPage from './FixedCostSettingsPage/EditFixedCostPage.duck';
import EditOptionsSettingsPage from './OptionsSettingsPage/EditOptionsSettingsPage.duck';
import EditTagSettingsPage from './TagSettingsPage/EditTagSettingsPage.duck';
...
export {
  ...
  ContactDetailsPage,
  EditListingPage,
  EditAccomodationPage,
  EditFixedCostPage,
  EditOptionsSettingsPage,
  EditTagSettingsPage,
  InboxPage,
  ListingPage,
  ManageListingsPage,
