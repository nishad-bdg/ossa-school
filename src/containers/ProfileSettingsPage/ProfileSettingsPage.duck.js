...
export const UPLOAD_IMAGE_SUCCESS =
  'app/ProfileSettingsPage/UPLOAD_IMAGE_SUCCESS';
export const UPLOAD_IMAGE_ERROR = 'app/ProfileSettingsPage/UPLOAD_IMAGE_ERROR';

export const UPDATE_PROFILE_REQUEST =
  'app/ProfileSettingsPage/UPDATE_PROFILE_REQUEST';
export const UPDATE_PROFILE_SUCCESS =
  'app/ProfileSettingsPage/UPDATE_PROFILE_SUCCESS';
export const UPDATE_PROFILE_ERROR =
  'app/ProfileSettingsPage/UPDATE_PROFILE_ERROR';
...
export default function reducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    case UPLOAD_IMAGE_SUCCESS: {
      ...
      console.info('uploaded image success', { ...state, image, uploadInProgress: false })
...
export function uploadImage(actionPayload) {
  return (dispatch, getState, sdk) => {
    ...
    return sdk.images
      ...
      .then(resp => {
        console.info('respose image upload', resp);
...
export const updateSchoolProfile = actionPayload => {
  console.log('action payload', actionPayload);
  return (dispatch, getState, sdk) => {
    dispatch(updateProfileRequest());
    ...
    const { email,profileImageId, ...rest } = actionPayload;
    return sdk.currentUser
      .updateProfile(
        {
          profileImageId,
