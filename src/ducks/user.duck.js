...
export const FETCH_SCHOOL_REQUEST = 'app/user/FETCH_SCHOOL_REQUEST'
export const FETCH_SCHOOL_SUCCESS = 'app/user/FETCH_SCHOOL_SUCCESS'
export const FETCH_SCHOOL_ERROR = 'app/user/FETCH_SCHOOL_ERROR'
...
// ================ Action creators ================ //
export const fetchSchoolListRequest = () =>  ({
  type: FETCH_SCHOOL_REQUEST
})

export const fetchSchoolListSuccess = schoolList => ({
  type: FETCH_SCHOOL_SUCCESS,
  payload: schoolList
})

export const fetchSchoolListError = e => ({
...
export const fetchSchool = () => (dispatch, getState, sdk) => {
  dispatch(fetchSchoolListRequest())
  ...
  return integrationSdk.users.query().then(res => {
    dispatch(fetchSchoolListSuccess(res.data.data))
	return res.data.data;
  }).catch(e => {
    fetchSchoolListError(storableError(e))
  })
};

export const fetchSchoolData = params => (dispatch, getState, sdk) => {
  dispatch(fetchSchoolListRequest())
  params.perPage = 3;
  return integrationSdk.users.query(params).then(res => {
    dispatch(fetchSchoolListSuccess(res.data.data))
	return res.data;
  }).catch(e => {
    fetchSchoolListError(storableError(e))
